...
while ($row = mysql_fetch_assoc($res))
{
	...
	if($row["id_tipo"]=='1')
	 ...
	 //Total Acumulado $eap 
	 $eap[$row["id_zona"]] =$e1p[$row["id_zona"]]+$e2p[$row["id_zona"]]+$e3p[$row["id_zona"]]+$e4p[$row["id_zona"]]+$e5p[$row["id_zona"]]+$e6p[$row["id_zona"]];
	 $ear[$row["id_zona"]] =$e1r[$row["id_zona"]]+$e2r[$row["id_zona"]]+$e3r[$row["id_zona"]]+$e4r[$row["id_zona"]]+$e5r[$row["id_zona"]]+$e6r[$row["id_zona"]];
	 
	 //$eap[$row["id_zona"]] += $row["programado_estrategia"];
	// $ear[$row["id_zona"]] += $row["real_estrategia"]
	 	 
	 //Total Divisional x estrategia
	 $edtp = $ed1p+$ed2p+$ed3p+$ed4p+$ed5p+$ed6p;
	 $edtr = $ed1r+$ed2r+$ed3r+$ed4r+$ed5r+$ed6r;
