...
if($MesesSelect =="")
		...
		echo "<div class=\"titulo\"> Avance de Programa 2015 </div>";
		echo "<div class=\"titulo\"> Mes : ".$NombredelMes[$MesesSelect]."</div>";	
		//echo $sql. "<BR>";
		} 
	else 
		{	
		...
		sum(tercera_semana) as tercera_semana, 
		sum(cuarta_semana)  as cuarta_semana
		FROM v_estrategias where id_mes <='".$MesesSelect."' group by id_zona,clave_estrategia,id_tipo";			
		//echo "Seguimiento de Estrategias: ".$NombredelMes[$MesesSelect];
...
<table border="1" id="datos" class="bordered" >
 <thead><tr>
    ...
    <th align="center">&nbsp; Control de Reacción de Ventas (CRV)</th>
    <th align="center">&nbsp;Blindaje de redes, Mediciones Comunales GWh</th>
    <th align="center">&nbsp;Fortalecimiento Proceso Comercial GWh</th>
    <th align="center">&nbsp;Implementación ASEMED  GWh</th>
    <th align="center">&nbsp;Fortalecimiento Infraestructura Eléctrica </th>
...
<?php foreach($zonas as $index=>$dato){?> 
 ...
 <tr>
    ...
    <td align="right">&nbsp;<?php echo number_format($eap[$index],2)."%";?></td> 
 </tr>
 <tr>
    <td>&nbsp;REAL</td>
    ...
    <td align="right">&nbsp;<?php echo number_format($ear[$index],2)."%";?></td>
 </tr>
 <?php }?> 
<tr>
 ...
 <tr>
    ...
    <td align="center">&nbsp;<?php echo number_format($edtr,2);?></td>  
 </tr>
 </table>
