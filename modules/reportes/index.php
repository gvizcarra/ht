...
$sql = "SELECT id_zona AS id, descripcion AS zona 
		FROM estrategias_isc.zonas WHERE id_zona IN(
   									SELECT DISTINCT id_zona AS zona 
										FROM estrategias_isc.estrategias 
									)";
$res = mysql_query($sql);
//echo $sql;
...
if($MesesSelect =="")
		...
		FROM v_estrategias where id_mes <='".$MesesSelect."' 
		group by id_zona,clave_estrategia,id_tipo";						
		echo "<div class=\"titulo\">Energía Recuperada</div>";
		echo "<div class=\"subtitulo\">EN kWh POR INVESTIGACIÓN  ISC 2015 </div>";
		...
		//echo "Seguimiento de Estrategias: ".$NombredelMes[$MesesSelect];	
		echo "<div class=\"titulo\">Energía Recuperada</div>";
		echo "<div class=\"subtitulo\">EN kWh POR INVESTIGACIÓN  ISC</div>";
		echo "<div class=\"subtitulo\"> Mes : ".$NombredelMes[$MesesSelect]."</div>";
		//echo $sql . "<BR>";
		}
...
while ($row = mysql_fetch_assoc($res))
{
	...
	if($row["id_tipo"]=='1')
	 ...
	 { 
	  ...
	  if($row["clave_estrategia"]=="6E")
	 { 
		if($row["id_tipo"]=='1')
	    	{ 
		$e6p[$row["id_zona"]]=$row["primera_semana"] + $row["segunda_semana"] + $row["tercera_semana"] + $row["cuarta_semana"];			
		$ed6p += $e6p[$row["id_zona"]];
			}
			else
			{
		$e6r[$row["id_zona"]] 	+= $row["primera_semana"]+$row["segunda_semana"]+$row["tercera_semana"]+$row["cuarta_semana"];
		$ed6r += $e6r[$row["id_zona"]];
		 	}		
	 }
	 
	   if($row["clave_estrategia"]=="7E")
	 { 
		if($row["id_tipo"]=='1')
	    	{ 
		$e7p[$row["id_zona"]]=$row["primera_semana"] + $row["segunda_semana"] + $row["tercera_semana"] + $row["cuarta_semana"];			
		$ed7p += $e7p[$row["id_zona"]];
			}
			else
			{
		$e7r[$row["id_zona"]] 	+= $row["primera_semana"]+$row["segunda_semana"]+$row["tercera_semana"]+$row["cuarta_semana"];
		$ed7r += $e7r[$row["id_zona"]];
		 	}		
	 }
	 
	 	   if($row["clave_estrategia"]=="8E")
	 { 
		if($row["id_tipo"]=='1')
	    	{ 
		$e8p[$row["id_zona"]]=$row["primera_semana"] + $row["segunda_semana"] + $row["tercera_semana"] + $row["cuarta_semana"];			
		$ed8p += $e8p[$row["id_zona"]];
			}
			else
			{
		$e8r[$row["id_zona"]] 	+= $row["primera_semana"]+$row["segunda_semana"]+$row["tercera_semana"]+$row["cuarta_semana"];
		$ed8r += $e8r[$row["id_zona"]];
		 	}		
	 }
	 
	  if($row["clave_estrategia"]=="9E")
	 { 
		if($row["id_tipo"]=='1')
	    	{ 
		$e9p[$row["id_zona"]]=$row["primera_semana"] + $row["segunda_semana"] + $row["tercera_semana"] + $row["cuarta_semana"];			
		$ed9p += $e9p[$row["id_zona"]];
			}
			else
			{
		$e9r[$row["id_zona"]] 	+= $row["primera_semana"]+$row["segunda_semana"]+$row["tercera_semana"]+$row["cuarta_semana"];
		$ed9r += $e9r[$row["id_zona"]];
		 	}		
	 }
	 ...
	 //Total Acumulado $eap 
	 $eap[$row["id_zona"]] =$e1p[$row["id_zona"]]+$e2p[$row["id_zona"]]+$e3p[$row["id_zona"]]+$e4p[$row["id_zona"]]+$e5p[$row["id_zona"]]+$e6p[$row["id_zona"]]+$e7p[$row["id_zona"]]+$e8p[$row["id_zona"]]+$e9p[$row["id_zona"]];
	 $ear[$row["id_zona"]] =$e1r[$row["id_zona"]]+$e2r[$row["id_zona"]]+$e3r[$row["id_zona"]]+$e4r[$row["id_zona"]]+$e5r[$row["id_zona"]]+$e6r[$row["id_zona"]]+$e7r[$row["id_zona"]]+$e8r[$row["id_zona"]]+$e9r[$row["id_zona"]];
	 
	 //$eap[$row["id_zona"]] += $row["programado_estrategia"];
	// $ear[$row["id_zona"]] += $row["real_estrategia"]
	 	 
	 //Total Divisional x estrategia
	 $edtp = $ed1p+$ed2p+$ed3p+$ed4p+$ed5p+$ed6p+$ed7p+$ed8p+$ed9p;
	 $edtr = $ed1r+$ed2r+$ed3r+$ed4r+$ed5r+$ed6r+$ed7r+$ed8r+$ed9r;
...
<table width="800" border="1" class="bordered" id="datos" >
 <thead><tr>
    <th colspan="2" align="center">&nbsp;ZONA</th>
    <th align="center" width="80">&nbsp;Consumo Cero</th>
    <th align="center" width="80">&nbsp;Denuncias Internas </th>
    <th align="center" width="80">&nbsp;Control de Reacción de Ventas</th>
    <th align="center" width="80">&nbsp;Historial de Consumo Div.</th>
    <th align="center" width="80">&nbsp;Medidores Trifásicos, Mufas Ocultas</th>
    <th align="center" width="80">&nbsp;Defecto Fabricacion Medidor</th>
    <th align="center" width="80">&nbsp;Giros Negros</th>
	<th align="center" width="80">&nbsp;Lecturas Intermedias</th>
    <th align="center" width="80">&nbsp;Medidor Inadecuado al Sistema</th>


    <th align="center" width="80">&nbsp;AVANCE</th> 
 </tr></thead>
...
<?php foreach($zonas as $index=>$dato){?> 
 ...
 <tr>
    ...
    <td align="center">&nbsp;<?php echo $e4p[$index];?></td>
    <td align="center">&nbsp;<?php echo $e5p[$index];?></td>
    <td align="center">&nbsp;<?php echo $e6p[$index];?></td>
    <td align="center">&nbsp;<?php echo $e7p[$index];?></td>
    <td align="center">&nbsp;<?php echo $e8p[$index];?></td>
    <td align="center">&nbsp;<?php echo $e9p[$index];?></td>
 ...
 <tr>
    ...
    <td align="center">&nbsp;<?php echo $e4r[$index];?></td>
    <td align="center">&nbsp;<?php echo $e5r[$index];?></td>
    <td align="center">&nbsp;<?php echo $e6r[$index];?></td>
    <td align="center">&nbsp;<?php echo $e7r[$index];?></td>
    <td align="center">&nbsp;<?php echo $e8r[$index];?></td>
    <td align="center">&nbsp;<?php echo $e9r[$index];?></td>
    <td align="center">
	<?php 	
...
<tr>
    ...
    <td align="center">&nbsp;<?php echo number_format($ed4p,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed5p,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed6p,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed7p,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed8p,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed9p,2);?></td>
 ...
 <tr>
    ...
    <td align="center">&nbsp;<?php echo number_format($ed4r,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed5r,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed6r,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed7r,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed8r,2);?></td>
    <td align="center">&nbsp;<?php echo number_format($ed9r,2);?></td>
    <td align="center">
    <?php 	
