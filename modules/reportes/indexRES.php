...
while ($row = mysql_fetch_assoc($res))
{
	...
	if($row["id_tipo"]=='1')
	 ...
	 //Total Acumulado $eap 
	 $eap[$row["id_zona"]] =$e1p[$row["id_zona"]]+$e2p[$row["id_zona"]]+$e3p[$row["id_zona"]]+$e4p[$row["id_zona"]]+$e5p[$row["id_zona"]]+$e6p[$row["id_zona"]]+$e7p[$row["id_zona"]]+$e8p[$row["id_zona"]];
	 $ear[$row["id_zona"]] =$e1r[$row["id_zona"]]+$e2r[$row["id_zona"]]+$e3r[$row["id_zona"]]+$e4r[$row["id_zona"]]+$e5r[$row["id_zona"]]+$e6r[$row["id_zona"]]+$e7r[$row["id_zona"]]+$e8r[$row["id_zona"]];
	 
	 //$eap[$row["id_zona"]] += $row["programado_estrategia"];
	// $ear[$row["id_zona"]] += $row["real_estrategia"]
	 	 
	 //Total Divisional x estrategia
	 $edtp = $ed1p+$ed2p+$ed3p+$ed4p+$ed5p+$ed6p+$ed7p+$ed8p;
	 $edtr = $ed1r+$ed2r+$ed3r+$ed4r+$ed5r+$ed6r+$ed7r+$ed8r;
...
<table width="800" border="1" class="bordered" id="datos" >
 <thead><tr>
    ...
    <th align="center" width="800">&nbsp;Consumo Cero</th>
    <th align="center" width="800">&nbsp;Denuncias Internas </th>
    <th align="center" width="800">&nbsp;Control de Reacción de Ventas</th>
    <th align="center" width="800">&nbsp;Historial de Consumo Div.</th>
    <th align="center" width="800">&nbsp;Medidores Trifásicos, Mufas Ocultas</th>
    <th align="center" width="800">&nbsp;Defecto Fabricacion Medidor</th>
    <th align="center" width="800">&nbsp;Giros Negros</th>
	<th align="center" width="800">&nbsp;Lecturas Intermedias</th>


    <th align="center" width="800">&nbsp;AVANCE</th> 
 </tr></thead>
