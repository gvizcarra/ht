...
<body>
    <h2>Avance de Estrategia de Perdidas Semanal SDD</h2>
   ...
   Zona:<select id="idZona">
    ...
    <script type="text/javascript">
        ...
        function load1(){
            ...
            $('#pg').pivotgrid({
                url:'avanceEstrategia_json.php?idZona='+par_idZona,
                method:'get',
				loadFilter:'myLoadFilter',
				pivot:{
                    rows:['estrategia','accion'],
                    columns:['mes','metaSemana'],
                    values:[
						...
						{field:'metaGwhAcum',title:'Meta Acum',width:65,op:'sum'},
						{field:'gwhAcum',title:'G Acum',width:55,op:'sum'},						
						{field:'metaEventosAcum',title:'Meta Evts Acum',width:60,op:'sum'},
						{field:'eventosAcum',title:'Evts Acum',width:50,op:'sum'}						 
                    ]
                },
                ...
                valuePrecision:2,
                   valueStyler:function(value,row,index){
							...
							if(/gwhAcum$/.test(this.field))
							{ x_gwhAcum = parseFloat(value)?parseFloat(value):parseFloat(0.00); }
							
							if(/metaGwhAcum$/.test(this.field))
							{ x_metaGwhAcum = parseFloat(value)?parseFloat(value):parseFloat(0.00); }
							...
							if(/eventosAcum$/.test(this.field))
						    { x_eventosAcum = parseFloat(value)?parseFloat(value):parseFloat(0.00); }
							
							if(/metaEventosAcum$/.test(this.field))
							{ x_metaEventosAcum = parseFloat(value)?parseFloat(value):parseFloat(0.00); }
							...
							if((/gwhAcum$/.test(this.field))&&(x_gwhAcum<x_metaGwhAcum) &&(x_metaGwhAcum>0))
							{ 
							 if(x_gwhAcum>(x_metaGwhAcum*.8))
							  { retornar = amarillo;}
							  else	
								{ retornar = rojo; }
							...
							if((/gwhAcum$/.test(this.field))&&(x_gwhAcum>=x_metaGwhAcum) )
							{return verde;}
							else if(/gwhAcum$/.test(this.field))
							{return rojo;}
							...
							if((/eventos$/.test(this.field))&&(x_eventos>=x_metaEventos))
							{return verde;}
							...
							if((/eventosAcum$/.test(this.field))&&(x_eventosAcum<x_metaEventosAcum)&&(x_metaEventosAcum>0))
							{ 
							 if(x_eventosAcum>(x_metaEventosAcum*.8))
							  { retornar = amarillo;}
							  else	 
								{ retornar = rojo; }
							...
							if((/eventosAcum$/.test(this.field))&&(x_eventosAcum>=x_metaEventosAcum))
							{return verde;}
							else if(/eventosAcum$/.test(this.field))
							{return rojo;}
