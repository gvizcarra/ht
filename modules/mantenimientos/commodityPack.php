...
<body>
	...
	<?php menu();?>
	<table id="dg" title="Commodity Label" style="width:700px;height:auto">
		<thead>
			<tr>
				<th field="name" width="50" editor="{type:'validatebox',options:{required:true}}">Label</th>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg').edatagrid({
				url: 'htCommodityLabel_json.php',
				saveUrl: 'htCommodityLabel_save.php',
				updateUrl: 'htCommodityLabel_save.php',
				destroyUrl: 'htCommodityLabel_del.php',
				toolbar : '#toolbar',
				pagination : true,
				pageSize:50,
				idField : 'id',
