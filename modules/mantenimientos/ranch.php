...
<body>
	...
	<?php menu();?>
	<table id="dg" title="Ranch" style="width:700px;height:auto">
		<thead>
			<tr>
				<th field="name" width="50" editor="{type:'validatebox',options:{required:true}}">Ranch</th>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg').edatagrid({
				url: 'htranch_json.php',
				saveUrl: 'htranch_save.php',
				updateUrl: 'htranch_save.php',
				destroyUrl: 'htranch_del.php',
				toolbar : '#toolbar',
				pagination : true,
				pageSize:50,
				idField : 'id',
